"""Import tick data from ~/data/raw/2025/202512 into futures_db (with resume)."""
...
DATA_ROOT = Path.home() / "data" / "raw" / "2025" / "202512"
...
def main():
    ...
    print(f"Found {len(tasks)} files to import, {skipped} already done.")
